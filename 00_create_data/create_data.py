...
filename = sys.argv[4] if len(sys.argv) > 0 else 'data.csv'  # Output filename
# C = int(sys.argv[5])  # Number of clusters (3 in the original code)

# initialization of centroids
# These centroids are used to generate the synthetic data.
centroids = [[-2.50919762,  9.01428613,  4.63987884,  1.97316968, -6.87962719,
...
def create_data(n, cluster_std, RSEED, C):
...
if __name__ == "__main__":
    ...
    df = create_data(n, cluster_std, RSEED, C=centroids)
